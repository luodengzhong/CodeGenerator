 ...
 {
   protected static final Log log = LogFactory.getLog(AbstractParser.class);
   ...
   protected String filterCommon(String readLine, GenerateModel model)
   {
     ...
     readLine = StringUtil.replaceAll(readLine, "@packageName", "package " +
       packageName);
     ...
     readLine = StringUtil.replaceAll(readLine, "@TABLENAME",
       StringUtil.isBlank(tableName) ? "" : tableName.toUpperCase());
     readLine = StringUtil.replaceAll(readLine, "@Object", objectName);
     readLine = StringUtil.replaceAll(readLine, "@tableComment",
       tableComment);
     readLine = readLine.replaceAll("@object",
       StringUtil.initialStrToLower(objectName));
